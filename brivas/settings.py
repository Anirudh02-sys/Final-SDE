"""
Django settings for brivas project.
...
SECRET_KEY = 'django-insecure-+z%k6f#lrx&ucyw29wvqb7ufxcgzo094$y(1!6j^-s4$lze=jn'
...
WSGI_APPLICATION = 'brivas.wsgi.application'
